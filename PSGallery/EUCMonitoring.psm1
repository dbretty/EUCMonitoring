...
Write-Verbose "Importing the Global Functions File"
$Public  = @( Get-ChildItem -Path $RootDirectory\modules\*.ps1 -ErrorAction SilentlyContinue )
...
#>
    ...
    if(test-path "$MonitoringPath\Modules"){
        Write-Verbose "Monitoring Directory $MonitoringPath Already Present"
    } else {
        New-Item "$MonitoringPath\Modules" -ItemType Directory
        Write-Verbose "EUC Monitoring Directory Created $MonitoringPath"
    }

    Write-Verbose "Pulling build-donut.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Build-Donut.ps1 -OutFile $MonitoringPath\modules\build-donut.ps1
    Write-Verbose "Pulling check-service.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Check-Service.ps1 -OutFile $MonitoringPath\modules\check-service.ps1
    Write-Verbose "Pulling connect-netscaler.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Connect-NetScaler.ps1 -OutFile $MonitoringPath\modules\connect-netscaler.ps1
    Write-Verbose "Pulling disconnect-netscaler.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Disconnect-NetScaler.ps1 -OutFile $MonitoringPath\modules\disconnect-netscaler.ps1
    Write-Verbose "Pulling connect-server.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Connect-Server.ps1 -OutFile $MonitoringPath\modules\connect-server.ps1
    Write-Verbose "Pulling Get-AAAUsers.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Get-AAAUsers.ps1 -OutFile $MonitoringPath\modules\Get-AAAUsers.ps1
    Write-Verbose "Pulling Get-ActivationStatus.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Get-ActivationStatus.ps1 -OutFile $MonitoringPath\modules\Get-ActivationStatus.ps1
    Write-Verbose "Pulling Get-Uptime.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Get-Uptime.ps1 -OutFile $MonitoringPath\modules\Get-Uptime.ps1
    Write-Verbose "Pulling Get-vServers.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Get-vServers.ps1 -OutFile $MonitoringPath\modules\Get-vServers.ps1
    Write-Verbose "Pulling New-HtmlReport.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/New-HtmlReport.ps1 -OutFile $MonitoringPath\modules\New-HtmlReport.ps1
    Write-Verbose "Pulling Send-SlackMessage.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Send-SlackMessage.ps1 -OutFile $MonitoringPath\modules\Send-SlackMessage.ps1
    Write-Verbose "Pulling Test-Controllers.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-Controllers.ps1 -OutFile $MonitoringPath\modules\Test-Controllers.ps1
    Write-Verbose "Pulling Test-Director.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-Director.ps1 -OutFile $MonitoringPath\modules\Test-Director.ps1
    Write-Verbose "Pulling Test-Licensing.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-Licensing.ps1 -OutFile $MonitoringPath\modules\Test-Licensing.ps1
    Write-Verbose "Pulling Test-NetConnection.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-NetConnection.ps1 -OutFile $MonitoringPath\modules\Test-NetConnection.ps1
    Write-Verbose "Pulling Test-NetScaler.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-NetScaler.ps1 -OutFile $MonitoringPath\modules\Test-NetScaler.ps1
    Write-Verbose "Pulling Test-ProvisioningServers.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-ProvisioningServers.ps1 -OutFile $MonitoringPath\modules\Test-ProvisioningServers.ps1
    Write-Verbose "Pulling Test-StoreFront.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-StoreFront.ps1 -OutFile $MonitoringPath\modules\Test-StoreFront.ps1
    Write-Verbose "Pulling Test-URL.ps1"
    Invoke-WebRequest -Uri https://raw.githubusercontent.com/dbretty/eucmonitoring/master/Package/modules/Test-URL.ps1 -OutFile $MonitoringPath\modules\Test-URL.ps1
    Write-Verbose "Pulling Test-XenServer.ps1"
